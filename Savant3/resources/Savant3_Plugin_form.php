...
class Savant3_Plugin_form extends Savant3_Plugin {
	...
	*/
	...
	/**
	* 
	* is the form generating elements within a fieldset block.
	* 
	* @access protected
	* 
	* @var bool
	...
	*/
	...
	/**
	* 
	* is the form generating elements as a group.
	* 
	* @access protected
	* 
	* @var bool
	...
	*/
	...
	/**
	* 
	* Central switcher API for the various public methods.
	* 
	* @access public
	* 
	...
	* returns from the method will be tidied.
	* 
	...
	* $this->form('element', $info), you can use this method to call
			...
			if (! $this->_inGroup) {
				...
				if ($this->_blockType == 'col') {
					...
					if (! is_null($label)) {
						...
						// add a require-sign flag if specified
						if ($require) {
	...
	* 
	* @param bool $require should the element have a "required" sign in the label.
	* 
	...
	*/
		...
		$feedback = null)
	{
		...
		if (! empty($feedback)) {
			...
			// force to arrays, we can have multiple feedback strings.
	...
	* Defaults to the value of $this->float.
	* 
	* @param string $clear Whether the block should be cleared of 'left'
	* and 'right' floating blocks (set to an empty string if you don't
	* want to clear).  Defaults to the value of $this->clear.
	* 
	...
	* @access protected
	* 
	* @return string|void The XHTML to end a block.
	* 
	*/
	...
	* @access protected
	* 
	* @return string|void The XHTML to split the layout with in a block.
	* 
	*/
